...
SELECT name, phone, coupon FROM match_m;

INSERT INTO REVIEW (NAME, PASSWORD, CONTENT, WRITE) VALUES ('홍길동', '1234', '맛있겠다', SYSDATE);
INSERT INTO REVIEW (NAME, PASSWORD, CONTENT, WRITE) VALUES ('성춘향', '1234', '배고프다', SYSDATE);
INSERT INTO REVIEW (NAME, PASSWORD, CONTENT, WRITE) VALUES ('이몽룡', '1234', '오징어 버거 기대되어요', SYSDATE);
INSERT INTO REVIEW (NAME, PASSWORD, CONTENT, WRITE) VALUES ('변사또', '1234', '오징오징', SYSDATE);
INSERT INTO REVIEW (NAME, PASSWORD, CONTENT, WRITE) VALUES ('길동이', '1234', 'ㅋㅋㅋㅋㅋㅋㅋㅋㅋ', SYSDATE);

SELECT  NAME, PASSWORD, CONTENT, HEART, WRITE, NUM FROM REVIEW